...
import org.openmrs.module.ohrireports.reports.datasetdefinition.datim.tx_ml.TxMlRefusedByAgeAndSexDataSetDefinition;
...
public class TxMlRefusedByAgeAndSexDataSetDefinitionEvaluator implements DataSetEvaluator {
	...
	private TxMlRefusedByAgeAndSexDataSetDefinition hdsd;
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext) throws EvaluationException {
		...
		hdsd = (TxMlRefusedByAgeAndSexDataSetDefinition) dataSetDefinition;
		context = evalContext;
		SimpleDataSet set = new SimpleDataSet(dataSetDefinition, evalContext);

        DataSetRow femaleDateSet = new DataSetRow();
        obses = getDatimTxMlRefused("F");
	...
	private List<Obs> getDatimTxMlRefused(String gender){
		...
		queryBuilder.select("obs")
				...
				.and()
				.whereEqual("obs.valueCoded", conceptService.getConceptByUuid(STOP))
