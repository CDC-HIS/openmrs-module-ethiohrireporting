...
public class HMISReport implements ReportManager {
	...
	public ReportDefinition constructReportDefinition() {
		...
		aDefinition
				.setDescription("06 - HIV | Hospital, Health center, Clinic |	Monthly (Federal Ministry Of Health)");
		...
		reportDefinition.addDataSetDefinition(
				"HMIS: Number of ART clients restarted ARV treatment in the reporting period",
