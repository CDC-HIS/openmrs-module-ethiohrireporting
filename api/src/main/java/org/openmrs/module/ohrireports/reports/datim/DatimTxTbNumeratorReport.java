...
public class DatimTxTbNumeratorReport implements ReportManager {
	...
	public ReportDefinition constructReportDefinition() {
		...
		aDefinition
				.setDescription(
						"Number of adults and children currently enrolling ART and has documented Active on TB treatment");
	...
	public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
		ReportDesign design = ReportManagerUtil.createExcelDesign("996a9b84-7d4a-4d13-9f7d-edeee916835c",
				reportDefinition);
