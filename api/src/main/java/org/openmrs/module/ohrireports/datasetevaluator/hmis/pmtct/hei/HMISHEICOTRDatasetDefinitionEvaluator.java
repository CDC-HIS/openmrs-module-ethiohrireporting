...
@Handler(supports = { HMISHEICOTRDatasetDefinition.class })
public class HMISHEICOTRDatasetDefinitionEvaluator implements DataSetEvaluator {
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext) throws EvaluationException {
		HMISHEICOTRDatasetDefinition dsd = (HMISHEICOTRDatasetDefinition) dataSetDefinition;
