...
public class HivPlHivDatasetDefinitionEvaluator implements DataSetEvaluator {
        ...
        public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
                ...
                switch (_datasetDefinition.getHivPvlHivType()) {
                        case PLHIV_TSP:
                                List<Person> assessedPatients = hivPlvHivQuery
                                                .getPersons(new Cohort(hivPlvHivQuery.getAssessedPatients()));
                                HivPlHivDatasetBuilder tspDatasetBuilder = new HivPlHivDatasetBuilder(assessedPatients,
                                                dataSet,
                                ...
                                break;
                        case PLHIV_NUT:
                                List<Person> moderatePatients = hivPlvHivQuery
                                                .getPersons(new Cohort(
                                                                hivPlvHivQuery.getPatientModerateMalNutrition()));
                                HivPlHivDatasetBuilder moderateDatasetBuilder = new HivPlHivDatasetBuilder(
                                                moderatePatients, dataSet,
                                                "Total MAM", "HIV_PLHIV_NUT_MAM");
                                moderateDatasetBuilder.getPlHivDataset();
                       
                                List<Person> severePatients = hivPlvHivQuery
                                                .getPersons(new Cohort(hivPlvHivQuery.getPatientSevereMalNutrition()));
                                HivPlHivDatasetBuilder severeDatasetBuilder = new HivPlHivDatasetBuilder(severePatients,
                                                dataSet,
                        ...
                        case PLHIV_SUP:
                                List<Person> supPatients = hivPlvHivQuery.getPersons(new Cohort(hivPlvHivQuery
                                                .getPatientTookSupplement(
                                                                hivPlvHivQuery.getPatientModerateMalNutrition())));
                                HivPlHivDatasetBuilder supDatasetBuilder = new HivPlHivDatasetBuilder(supPatients,
                                                dataSet,
                                ...
                                List<Person> sevSupPatients = hivPlvHivQuery.getPersons(new Cohort(hivPlvHivQuery
                                                .getPatientTookSupplement(
                                                                hivPlvHivQuery.getPatientSevereMalNutrition())));
                                HivPlHivDatasetBuilder sevSupDatasetBuilder = new HivPlHivDatasetBuilder(sevSupPatients,
                                                dataSet,
