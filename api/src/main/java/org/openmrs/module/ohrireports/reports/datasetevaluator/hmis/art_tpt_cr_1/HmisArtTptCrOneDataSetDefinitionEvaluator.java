package org.openmrs.module.ohrireports.reports.datasetevaluator.hmis.art_tpt_cr_1;
...
public class HmisArtTptCrOneDataSetDefinitionEvaluator implements DataSetEvaluator {
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext) throws EvaluationException {
        ...
        data.addData(new DataSetColumn("HIV_ART_TPT_CR.1","Number of ART patients who were initiated on any course of TPT 12 months before the reporting period",String.class)
		," ");
		obses = getTPTTreatmentBYType(TB_PROPHYLAXIS_TYPE,TB_PROPHYLAXIS_TYPE_INH);
        data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.1","Patients on 6H 12 months prior to the reporting period",Integer.class)
		,obses.size());
		data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.1. 1","< 15 years, Male",Integer.class)
		,gettbscrnByAgeAndGender(0,15,Gender.Male));
		data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.1. 2","< 15 years, female",Integer.class)
		,gettbscrnByAgeAndGender(0,15,Gender.Female));
		data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.1. 3",">= 15 years, Male",Integer.class)
		,gettbscrnByAgeAndGender(15,150,Gender.Male));
		data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.1. 4",">= 15 years, female",Integer.class)
        ...
        data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.2","Patients on 3HP 12 months prior to the reporting period",Integer.class)
		,obses.size());
		data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.2. 1","< 15 years, Male",Integer.class)
		,gettbscrnByAgeAndGender(0,15,Gender.Male));
		data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.2 2","< 15 years, female",Integer.class)
		,gettbscrnByAgeAndGender(0,15,Gender.Female));
		data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.2. 3",">= 15 years, Male",Integer.class)
		,gettbscrnByAgeAndGender(15,150,Gender.Male));
		data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.2. 4",">= 15 years, female",Integer.class)
		,gettbscrnByAgeAndGender(15,150,Gender.Female));

		obses = getTPTTreatmentBYType(TB_PROPHYLAXIS_TYPE_ALTERNATE,TB_PROPHYLAXIS_TYPE_ALTERNATE_3HR);
        data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.3","Patients on 3HR 12 months prior to the reporting period",Integer.class)
		,obses.size());
		data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.3. 1","< 15 years, Male",Integer.class)
		,gettbscrnByAgeAndGender(0,15,Gender.Male));
		data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.3. 2","< 15 years, female",Integer.class)
		,gettbscrnByAgeAndGender(0,15,Gender.Female));
		data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.3. 3",">= 15 years, Male",Integer.class)
		,gettbscrnByAgeAndGender(15,150,Gender.Male));
		data.addData(new DataSetColumn("HIV_ART_TPT_CR.1.3. 4",">= 15 years, female",Integer.class)
		,gettbscrnByAgeAndGender(15,150,Gender.Female));
