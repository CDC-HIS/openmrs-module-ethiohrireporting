...
public class HivLinkageNewCtQuery extends BaseEthiOhriQuery {
    ...
    private Cohort allCohort,
            linkedToCareCohort,
            knownCohort,
            lostToFollowUpCohort,
            referToOtherCohort,
            diedCohort;
    ...
    private void fillCohort(Cohort cohort, String question, String answer) {
        ...
        sqlLinkedToCare
                .append(" and c.value_coded= (select distinct concept_id from concept where uuid= '" + answer
                        + "'  LIMIT 1) ");
    ...
    private void fillCohort(Cohort cohort, String question, List<String> answers) {
        ...
        sqlLinkedToCare
                .append(" and c.value_coded in (select distinct concept_id from concept where uuid in (:answers)) ");
        sqlLinkedToCare.append(" and " + OBS_ALIAS + "person_id in (:personIds)");
