...
public class MonthlyVisitDatasetEvaluator implements DataSetEvaluator {
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
		...
		HashMap<Integer, Object> mrnIdentifierHashMap = monthlyVisitQuery.getIdentifier(
				monthlyVisitQuery.getBaseCohort(),
				MRN_PATIENT_IDENTIFIERS);
		HashMap<Integer, Object> uaIdentifierHashMap = monthlyVisitQuery.getIdentifier(
				monthlyVisitQuery.getBaseCohort(),
				UAN_PATIENT_IDENTIFIERS);
		HashMap<Integer, Object> artStartDictionary = monthlyVisitQuery.getArtStartDate(
				monthlyVisitQuery.getBaseCohort(),
				null, dsd.getEndDate());
		...
		HashMap<Integer, Object> tbScreening = monthlyVisitQuery.getByResult(TB_SCREENED,
				monthlyVisitQuery.getBaseCohort(),
				monthlyVisitQuery.getEncounter());
		...
		for (Person person : personList) {
			...
			row.addColumnValue(new DataSetColumn("UAN", "UAN", String.class),
					uaIdentifierHashMap.get(person.getPersonId()));
			...
			row.addColumnValue(new DataSetColumn("ARVDoseDays", "ARVDoseDays", String.class),
