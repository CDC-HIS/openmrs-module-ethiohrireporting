...
import org.openmrs.module.ohrireports.reports.datasetdefinition.datim.tx_ml.TxMlDiedByAgeAndSexDataSetDefinition;
...
public class TxMlDiedByAgeAndSexDataSetDefinitionEvaluator implements DataSetEvaluator {
	...
	private TxMlDiedByAgeAndSexDataSetDefinition hdsd;
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext) throws EvaluationException {
		...
		hdsd = (TxMlDiedByAgeAndSexDataSetDefinition) dataSetDefinition;
		context = evalContext;
        SimpleDataSet set = new SimpleDataSet(dataSetDefinition, evalContext);

        DataSetRow femaleDateSet = new DataSetRow();
        obses = getDatimTxMlDied("F");
	...
	private List<Obs> getDatimTxMlDied(String gender){
		...
		queryBuilder.select("obs")
				...
				.and()
				.whereEqual("obs.valueCoded", conceptService.getConceptByUuid(DEAD))
