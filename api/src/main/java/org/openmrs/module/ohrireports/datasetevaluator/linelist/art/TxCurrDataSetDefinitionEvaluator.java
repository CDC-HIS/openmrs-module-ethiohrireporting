    ...
    public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext) throws EvaluationException {
        ...
        if (!persons.isEmpty()) {
            ...
            data.addRow(LineListUtilities.buildEmptyRow(Arrays.asList("#", "GUID", "Patient Name", "MRN", "UAN",
                    ...
                    "Familiy Planning Method", "Pregnant?", "Breastfeeding?", "On PMTCT?", "TPT Start Date", "TPT Completed Date", "TB Treatment Completed Date",
        ...
        for (Person person : persons) {
            ...
            row.addColumnValue(new DataSetColumn("Therapeutic/ Supplementary Food", "Therapeutic/ Supplementary Food",
                    String.class), therapeuticSupplementaryHashMap.get(person.getPersonId()));
